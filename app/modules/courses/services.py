...
class CourseService(CRUDBase[Course]):
    ...
    async def update_course(
        self, course_id: str, data: CourseUpdate, updated_by: str
    ) -> Course:
        """Update course details after checking for duplicate code."""
        ...
        return await self.update(
            course_id, data.model_dump(exclude_unset=True), updated_by
        )
